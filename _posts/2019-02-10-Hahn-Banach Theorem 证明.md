...
在假期中想到这个定理，但是记不得定理的证明了，在 Google 上搜索了许多，这方面中文的资料比较的少，更多的集中在定理的应用上，于是回到学校之后参考老师的讲义，将这个定理的证明记录下来。并不是说我自己对掌握这个定理的证明有多大的执念，只是想留下这一篇 Post 来提示自己好好学习数学，诸多学科都会要求一定的数学功底。
...
故 $$\varphi (ix)=-\psi (x)$$. 因此 $$f(x)=\varphi (x)-i\varphi (ix)$$.
...
则 $$-p(x)=-p(-x)\le -F(-x)=F(x)\le p(x)$$. 故 $$|F(x)|\le p(x)$$.
...
泛函分析在经济学中的应用相当的广泛，参考知乎的问题 https://www.zhihu.com/question/31913447/answer/53821730。

中英切换打公式真的是心累啊，还是英文 Paper 不用切换中英方便。